...
กำหนดยอดเงินจากฝั่งเซิร์ฟเวอร์ อย่าเชื่อยอดเงินที่ส่งมาจากฝั่งไคลเอนต์ `amount` เป็นสตริงเลขทศนิยมสกุล USD ตั้งแต่ `'0.01'` ถึง `'1000000.00'` ทศนิยมไม่เกิน 2 ตำแหน่ง เช่น `'129'` หรือ `'129.99'`
